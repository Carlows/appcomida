    ...
    public class AppInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext db)
        {
            List<Registro> registros = new List<Registro>
            {
                ...
                new Registro { Producto = new Producto { Nombre = "Harina Pan", Precio = 120, Regulado = false }, Direccion = new Direccion { Estado = "Carabobo", Ciudad = "Guacara", Local = "SAS", DireccionLocal = "Sector 2 lorem ipsum", Position = new GoogleMapPoint { Latitud = 2.0f, Longitud = 2.0f } }},
